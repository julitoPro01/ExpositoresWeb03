<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Curso.aspx.cs" Inherits="ExpositoresWeb03.src.pages.Curso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <br />
     <h3 class="fs-3 text-light" > Cursos </h3>
     <br />
     ...
     <div class="m-2 p-0" >     
          ...
          <div class="d-flex justify-content-center input-group mb-3" style="max-width:500px">
                <asp:TextBox Class="" ID="search" CssClass="form-control" runat="server" AutoPostBack="true" Placeholder="Buscar por Descripción" OnTextChanged="search_TextChanged"></asp:TextBox>
           ...
           <asp:GridView CssClass="w-100" ID="idCursoGrid" runat="server" BackColor="Silver" BorderColor="#CCCCCC"
         BorderStyle="None" BorderWidth="1px" CellPadding="7" GridLines="Horizontal"
         AutoGenerateColumns="False" AllowPaging="True"
         OnPageIndexChanging="idCursoGrid_PageIndexChanging" CellSpacing="5" OnRowDataBound="idCursoGrid_RowDataBound" OnSelectedIndexChanged="idCursoGrid_SelectedIndexChanged1" AutoGenerateSelectButton="True" HorizontalAlign="Center">
         <Columns>
             <asp:BoundField DataField="cod_curso" HeaderText="Nro" />
             <asp:BoundField DataField="descripcion" HeaderText="Descripción" />
             <asp:BoundField DataField="horas_teoria" HeaderText="Horas teoria" />
             <asp:BoundField DataField="horas_practica" HeaderText="Horas practica" />
             <asp:BoundField DataField="nivel_dificultad" HeaderText="Nivel de dificultad" />
     ...
     <Triggers>
     <asp:AsyncPostBackTrigger ControlID="idCursoGrid" EventName="PageIndexChanging" />
     </Triggers>
     </asp:UpdatePanel>
     ...
     <br />
      ...
      <div class="d-flex justify-content-around  m-0 p-2 rounded" style="position:sticky;bottom:0px;background-color:#5d6d7e" >
        ...
        <br />
          <asp:Button CssClass="mx-2 btn btn-outline-light"  ID="Button1" runat="server" PostBackUrl="~/src/pages/view/ViewAddCurso.aspx" Text="Añadir" />
         <asp:Button CssClass="mx-2 btn btn-outline-warning" ID="btnviewUpdate" runat="server" PostBackUrl="~/src/pages/view/ViewUpdateCurso.aspx" Text="Actualizar" />
