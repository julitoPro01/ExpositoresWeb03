<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewAddAsociado.aspx.cs" Inherits="ExpositoresWeb03.src.pages.view.ViewAddAsociado" async="true" %>
...
<hr style="color:gray" />
    ...
    <table class="pe-4 auto-style15">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="InputCel" runat="server" CssClass="w-100 rounded p-2" MaxLength="9"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <div class="row px-3 mt-3">
        <div class="col-12 col-lg-6">
            ...
            <label for="fechaIngreso" id="Labelfechaingreso"  class="text-light" >Fecha de Ingreso* :</label>        
            <asp:Calendar ID="fechaIngreso" runat="server" CssClass="calendar text-dark bg-light" />
        </div>
        <div class="col-12 col-lg-6">

            <label for="fechaUlCap" id="LabelfechaUlCap" class="text-light" >Ultima capacitación* :</label>        
