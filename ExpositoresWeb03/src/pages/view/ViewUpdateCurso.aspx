<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewUpdateCurso.aspx.cs" Inherits="ExpositoresWeb03.src.pages.view.ViewUpdateCurso" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

        <div class="py-3 mb-4 text-light ">
    ...
    <h3 class="mx-4 pt-2 text-light" style="display:inline-block" >Actualizar</h3>
        ...
        <span class="fs-2" >Codigo: </span>    <asp:Label CssClass="fs-2 text-danger" ID="LabelIdCurso" runat="server" Text=""></asp:Label>
     </div>
