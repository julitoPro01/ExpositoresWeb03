<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Asociado.aspx.cs" Inherits="ExpositoresWeb03.src.pages.Asociado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <br />
        <h3 class="fs-3 text-light" > Asociados </h3>
        <br />
        ...
        <div class="m-2 p-0" > 
             ...
             <div class="d-flex justify-content-center input-group mb-3" style="max-width:500px">
              ...
              <asp:GridView CssClass="w-100" ID="idAsociadoGrid" runat="server" BackColor="Silver" BorderColor="#CCCCCC"
            BorderStyle="None" BorderWidth="1px" CellPadding="7" GridLines="Horizontal"
            AutoGenerateColumns="False" AllowPaging="True"
            OnPageIndexChanging="idAsociadoGrid_PageIndexChanging" CellSpacing="5" OnRowDataBound="idAsociadoGrid_RowDataBound" OnSelectedIndexChanged="idAsociadoGrid_SelectedIndexChanged1" AutoGenerateSelectButton="True" HorizontalAlign="Center">
            <Columns>
                <asp:BoundField DataField="cod_asociado" HeaderText="Nro" />
                <asp:BoundField DataField="ape_paterno" HeaderText="Ape.Paterno" />
                <asp:BoundField DataField="ape_materno" HeaderText="Ape.Materno" />
                <asp:BoundField DataField="nombres" HeaderText="Nombre" />
                <asp:BoundField DataField="tlf_celular" HeaderText="Telefono" />
                <asp:BoundField DataField="fech_ult_capacitacion" HeaderText="Ultima capacitación" DataFormatString="{0:dd/MM/yyyy}" />
 
               <asp:TemplateField HeaderText="Foto">
               <ItemTemplate>
                    <asp:Image ID="imgFoto" runat="server" ImageUrl='<%# Eval("foto") %>' Width="100px" Height="100px" />
               </ItemTemplate>
               </asp:TemplateField>
        ...
        <Triggers>
        <asp:AsyncPostBackTrigger ControlID="idAsociadoGrid" EventName="PageIndexChanging" />
        </Triggers>
        </asp:UpdatePanel>
        ...
        <br />
         ...
         <div class="d-flex justify-content-around  m-0 p-2 rounded" style="position:sticky;bottom:0px;background-color:#5d6d7e" >
           ...
           <br />
             <asp:Button CssClass="mx-2 btn btn-outline-light"  ID="Button1" runat="server" PostBackUrl="~/src/pages/view/ViewAddAsociado.aspx" Text="Añadir" />
            <asp:Button CssClass="mx-2 btn btn-outline-warning" ID="btnviewUpdate" runat="server" PostBackUrl="~/src/pages/view/ViewUpdateAsociado.aspx" Text="Actualizar" />
